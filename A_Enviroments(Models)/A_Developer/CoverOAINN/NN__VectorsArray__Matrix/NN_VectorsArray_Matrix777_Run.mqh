...
//|                                                                  |
//+------------------------------------------------------------------+
class NN_VectorsArray_Matrix777_NetWork
{
public:
          NN_VectorsArray_Matrix777_NetWork(void) {};
          ~NN_VectorsArray_Matrix777_NetWork(void) {};
          ...
          NN_VectorsArray_Matrix777_NetWork(VectorZ<uint> *ftopology, double fLearningRate, double fMomentom, double fRASF):
                    _toplogy(ftopology),
                    // _weightMatrices({0.0}),
                    // _valueMatrices({0.0}),
                    // _biasMatrices({0.0}),
          ...
          {         _LearningRate = fLearningRate;   _Momentom = fMomentom;  _RASF = fRASF;
                    ...
                    //
                    for(int i = 0; i < _toplogy.size() - 1; i++)
                    {         CMatirx_Vector<double>  weightMatriX(_toplogy[i + 1], _toplogy[i]);
                              ...
                              //
                              CMatirx_Vector<double>  biasMatriX(_toplogy[i + 1], _toplogy[i]);
                    ...
                    _valueMatrices.resize(_toplogy.size(), sample); //
          }
          ...
          {         //Print("NN_VectorsArray_Matrix777_Run   training NET_FeedForward...");
                    ...
                    //Print("NN_VectorsArray_Matrix777_Run   training NET_FeedForward to next layers...");
          ...
          {         //Print("NN_VectorsArray_Matrix777_Run   training BackPropagate...");
                    ...
                    //Print("NN_VectorsArray_Matrix777_Run   training BackPropagate to next layers...");
                    ...
                    {         CMatirx_Vector<double> tans               = _weightMatrices[i].transpose();
                              ...
                              CMatirx_Vector<double> deltas             = gradients.multiplyScaler(_LearningRate);
                              CMatirx_Vector<double> weightGradients    = _valueMatrices[i].transpose().multiply(deltas);
...
//|                                                                  |
//+------------------------------------------------------------------+
class NN_VectorsArray_Matrix777_Run
{
public:


          NN_VectorsArray_Matrix777_Run(void) {};
          ~NN_VectorsArray_Matrix777_Run(void) {};

          void __MainRun__()
          {         VectorZ<uint> *topology = new VectorZ<uint>; topology.add(2); topology.add(3); topology.add(1);
                    NN_VectorsArray_Matrix777_NetWork nn( topology, 0.1, 0.5, 100);//'100f' - invalid number NN_Matrix_Run.mqh   61        72
                    ...
                    TrainingOutputs.add(TrainingOutputs1);
                    TrainingOutputs.add(TrainingOutputs2);
                    TrainingOutputs.add(TrainingOutputs3);
                    TrainingOutputs.add(TrainingOutputs4);
                    //
                    uint epoch = 10;
                    Print("NN_VectorsArray_Matrix777_Run   training started...");
                    ...
                    Print("NN_VectorsArray_Matrix777_Run   training Completed...");
                    ...
                    //                "  preds[", indexkeep, "]->: ", preds[indexkeep],
                    //                "  indexkeep:", indexkeep
                    //               );
                    //          indexkeep++;
                    //          //
