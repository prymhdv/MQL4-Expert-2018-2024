...
struct S_GANN_FAN: public _COBF_
{         //============================================================================================================
          void                  S_GANN_FAN() {TYPE_O_00 = OBJ_GANNFAN;}; // {Point2XY(0, 0, 0, 0);}; //S_HLINE.PointTime.TIME1==0  S_HLINE.PointTime.PRICE1==0  S_HLINE.PointTime.TIME2==0   S_HLINE.PointTime.PRICE2==0
...
// C_Objects             C_GannsFan::OBJ;
class C_GannsFan: public __COBFA__<S_GANN_FAN> 
{
//===================================================================
private:
          string                 m_name;
...
//|                                                                  |
//+------------------------------------------------------------------+
bool C_GannsFan::Create(int                 mode            = MODE_CREATE,
                        bool                IsKey          = false,
                        string              Name            = "LineV",
                        datetime            XCordinate      = 0,
                        ENUM_LINE_STYLE     Style           = 1,
