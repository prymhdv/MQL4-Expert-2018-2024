...
//+------------------------------------------------------------------+
struct S_ArrowsRightPrice: public _COBF_
{         void                  S_ArrowsRightPrice() {TYPE_O_00 = OBJ_ARROW_RIGHT_PRICE;}
//============================================================================================================
...
//       C_Objects                     C_ArrowsRightPrice::OBJ;
class C_ArrowsRightPrice: public __COBFA__<S_ArrowsRightPrice>  
{
private:
//============================================================
public:
          void                          C_ArrowsRightPrice() {};
          void                          ~C_ArrowsRightPrice() {if(Capitan_DeinitErrorCatching)________________________________________________________Xerorr.SuperviserX(_LastError, "-C_ArrowsRightPrice Error",  __LINE__, __FUNCTION__); }
//============================================================ ChartObjectsArrows.mqh
          CChartObjectArrowRightPrice   GAC;
          S_ArrowsRightPrice            GDS;
