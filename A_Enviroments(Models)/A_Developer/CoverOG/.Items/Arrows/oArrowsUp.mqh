...
//+------------------------------------------------------------------+
struct S_ArrowsUp: public _COBF_
{         void                  S_ArrowsUp() {TYPE_O_00 = OBJ_ARROW_UP;}
          //============================================================================================================
...
//       C_Objects                     C_ArrowsUp::OBJ;
class C_ArrowsUp: public __COBFA__<S_ArrowsUp> 
{
private:
//============================================================
public:
          void                           C_ArrowsUp()  {};
          void                           ~C_ArrowsUp() {if(Capitan_DeinitErrorCatching)________________________________________________________Xerorr.SuperviserX(_LastError, "-C_ArrowsUp Error",  __LINE__, __FUNCTION__); }
//============================================================ ChartObjectsArrows.mqh
          CChartObjectArrowUp            GAC;
          S_ArrowsUp                     GDS;
       
//============================================================
          bool          C_ArrowsUp::Create(int      mode    = MODE_CREATE,
                                           bool     IsKey  = false,
                                           string   Name    = "ArrowUp") {return false;};
//============================================================
};
//+------------------------------------------------------------------+
//|             Class SoundController     BEGIN                      |
