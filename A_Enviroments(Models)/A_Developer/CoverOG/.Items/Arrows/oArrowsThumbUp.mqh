...
//+------------------------------------------------------------------+
struct S_ArrowsThumbUp: public _COBF_
{         void                  S_ArrowsThumbUp() {TYPE_O_00 = OBJ_ARROW_THUMB_UP;}
          //============================================================================================================
...
//       C_Objects                     C_ArrowsThumbUp::OBJ;
class C_ArrowsThumbUp: public __COBFA__<S_ArrowsThumbUp>  
{
private:
//============================================================
public:
          void                                  C_ArrowsThumbUp() {};
          void                                  ~C_ArrowsThumbUp() {if(Capitan_DeinitErrorCatching)________________________________________________________Xerorr.SuperviserX(_LastError, "-C_ArrowsThumbUp Error",  __LINE__, __FUNCTION__); }
//============================================================ ChartObjectsArrows.mqh
          CChartObjectArrowThumbUp              GAC;
          S_ArrowsThumbUp                       GDS;
