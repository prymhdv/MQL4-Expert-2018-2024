...
//+------------------------------------------------------------------+
struct S_ArrowsCheck: public _COBF_
{         void                  S_ArrowsCheck() {TYPE_O_00 = OBJ_ARROW_CHECK;}
//============================================================================================================
...
//       C_Objects                     C_ArrowsCheck::OBJ;
class C_ArrowsCheck: public __COBFA__<S_ArrowsCheck> 
{
private:
//============================================================
public:
          void                           C_ArrowsCheck() {};
          void                          ~C_ArrowsCheck() {if(Capitan_DeinitErrorCatching)________________________________________________________Xerorr.SuperviserX(_LastError, "-C_ArrowsCheck Error",  __LINE__, __FUNCTION__); }
//============================================================ ChartObjectsArrows.mqh
          CChartObjectArrowCheck        GGAC;
          S_ArrowsCheck                 GDS;
           
//============================================================
          bool          C_ArrowsCheck::Create(int      mode    = MODE_CREATE,
                                              bool     IsKey  = false,
