...
struct S_ArrowsSell: public _COBF_
{         void                  S_ArrowsSell() {TYPE_O_00 = OBJ_ARROW_SELL;}
//============================================================================================================
...
// C_Objects             C_ArrowsSell::OBJ;
class C_ArrowsSell: public __COBFA__<S_ArrowsSell> 
{
//===================================================================
private:
          string                m_name;
...
//===================================================================
          bool                  Create(int                  mode            = MODE_CREATE,
                                       bool                 IsKey          = false,
                                       string               Name            = "ArrowSell",
                                       long                 chart_ID        = 0,            // chart's ID
                                       int                  sub_window      = 0,            // subwindow index
                                       datetime             time            = 0,            // anchor point time
                                       double               price           = 0,            // anchor point price
                                       color                clr             = C'225,68,29', // sign color
...
//| Create Sell sign                                                 |
//+------------------------------------------------------------------+
bool C_ArrowsSell::Create(int                  mode            = MODE_CREATE,
                          bool                 IsKey          = false,
                          string               Name            = "ArrowSell",
                          long                 chart_ID        = 0,            // chart's ID
                          int                  sub_window      = 0,            // subwindow index
...
//+------------------------------------------------------------------+
bool C_ArrowsSell::ArrowSellMove(const long   chart_ID = 0,     // chart's ID
                                 const string name = "ArrowSell", // object name
                                 datetime     time = 0,         // anchor point time coordinate
                                 double       price = 0)        // anchor point price coordinate
{
...
//| Delete Sell sign                                                 |
//+------------------------------------------------------------------+
bool C_ArrowsSell::ArrowSellDelete(const long   chart_ID = 0,     // chart's ID
                                   const string name = "ArrowSell") // sign name
{
//--- reset the error value
          ResetLastError();
...
//| for empty ones                                                   |
//+------------------------------------------------------------------+
void C_ArrowsSell::ChangeArrowEmptyPoint(datetime &time, double &price)
{
...
//--- create Sell signs in High point for each visible bar
          ...
          {         // if(!Create(0, "ArrowSell_" + (string)i, 0, date[i], high[i], InpColor))
                    return;
