...
//|                                                                  |
//+------------------------------------------------------------------+
struct S_ArrowsStop: public _COBF_
{         void                  S_ArrowsStop() {TYPE_O_00 = OBJ_ARROW_STOP;}
          //============================================================================================================
...
//       C_Objects                     C_ArrowsStop::OBJ;
class C_ArrowsStop: public __COBFA__<S_ArrowsStop>  
{
private:
//============================================================
public:
          void                                  C_ArrowsStop() {};
          void                                  ~C_ArrowsStop() {if(Capitan_DeinitErrorCatching)________________________________________________________Xerorr.SuperviserX(_LastError, "-C_ArrowsStop Error",  __LINE__, __FUNCTION__); }
//============================================================ ChartObjectsArrows.mqh
          CChartObjectArrowStop                 GAC;
          S_ArrowsStop                          GDS;
          
//============================================================
          bool          C_ArrowsStop::Create(int      mode    = MODE_CREATE,
                                             bool     IsKey  = false,
                                             string   Name    = "ArrowStop") {return false;};
//============================================================
};
//+------------------------------------------------------------------+
//|             Class SoundController     BEGIN                      |
