...
struct S_FIBO_ARC: public _COBF_
{         //============================================================================================================
          void                  S_FIBO_ARC() {TYPE_O_00 = OBJ_FIBOARC;}; // {Point2XY(0, 0, 0, 0);}; //S_HLINE.PointTime.TIME1==0  S_HLINE.PointTime.PRICE1==0  S_HLINE.PointTime.TIME2==0   S_HLINE.PointTime.PRICE2==0
          ...
          bool                  SetScale(double scale)          {   SCALE               = scale;        return true;}
          bool                  SetEllipse(bool ellipse)        {   ELLIPSE             = ellipse;      return true;}
          ...
          {         if(IsCreated)return false;
                    ...
                    TYPE_O_00                     /*= FRAME.TYPE*/            = OBJ_FIBOARC;
          ...
          //OBJECT.Ellipse(ELLIPSE);        //ObjectSetInteger(ChartData_ChartInfo.ID, OBJ.CName, OBJPROP_ELLIPSE, ELLIPSE);//
          ////----------------------------------
...
class C_FibosArc: public __COBFA__<S_FIBO_ARC> 
{
//---
private:
          string                        m_name;
...
public:
          void                          C_FibosArc() {};
          void                          ~C_FibosArc() {if(Capitan_DeinitErrorCatching)________________________________________________________Xerorr.SuperviserX(_LastError, "-C_FibosArc Error",  __LINE__, __FUNCTION__); }
//---CChartObjectFibo
          CChartObjectFiboArc           GAC;       ///---API  Invoke---///
          S_FIBO_ARC                    GDS;       ///---Mine Invoke---///
...
//---
          bool                          PeriodCurrent_Gradient;//       = TimeCordinateOne > TimeCordinateTwo;
          bool                          PeriodDaily_Gradient;//       = TimeCordinateOne > TimeCordinateTwo;
          bool                          Period4Hour_Gradient;//       = TimeCordinateOne > TimeCordinateTwo;
          bool                          Period30Min_Gradient;//       = TimeCordinateOne > TimeCordinateTwo;
          bool                          Period5Min_Gradient;//       = TimeCordinateOne > TimeCordinateTwo;
          ...
          //-------------
          double                        CPriceCordinateOne;//   = PriceCordinateOne;
          datetime                      CTimeCordinateOne;//    = TimeCordinateOne;
          double                        CPriceCordinateTwo;//   = PriceCordinateTwo;
          datetime                      CTimeCordinateTwo;//    = TimeCordinateTwo;
          double                        CPriceCordinateThree;// = PriceCordinateThree;
          datetime                      CTimeCordinateThree;//  = TimeCordinateThree;
          ///----------------------------------
          //case  PERIOD_CURRENT:           //
          //================================================================= 
          double                         PeriodCurrent_PriceCordinateOne  ;//    = PriceCordinateOne;
          datetime                       PeriodCurrent_TimeCordinateOne   ;//    = TimeCordinateOne;
          double                         PeriodCurrent_PriceCordinateTwo  ;//    = PriceCordinateTwo;
          datetime                       PeriodCurrent_TimeCordinateTwo   ;//    = TimeCordinateTwo;
          double                         PeriodCurrent_PriceCordinateThree;//    = PriceCordinateThree;
          datetime                       PeriodCurrent_TimeCordinateThree ;//    = TimeCordinateThree;
          //=================================================================

          //case  PERIOD_D1:           //
          //================================================================= 
          double                         PeriodDaily_PriceCordinateOne     ;//   = PriceCordinateOne;
          datetime                       PeriodDaily_TimeCordinateOne      ;//   = TimeCordinateOne;
          double                         PeriodDaily_PriceCordinateTwo     ;//   = PriceCordinateTwo;
          datetime                       PeriodDaily_TimeCordinateTwo      ;//   = TimeCordinateTwo;
          double                         PeriodDaily_PriceCordinateThree   ;//   = PriceCordinateThree;
          datetime                       PeriodDaily_TimeCordinateThree    ;//   = TimeCordinateThree;
          //=================================================================

          //case  PERIOD_H4:
          //================================================================= 
          double                         Period4Hour_PriceCordinateOne      ;//  = PriceCordinateOne;
          datetime                       Period4Hour_TimeCordinateOne       ;//  = TimeCordinateOne;
          double                         Period4Hour_PriceCordinateTwo      ;//  = PriceCordinateTwo;
          datetime                       Period4Hour_TimeCordinateTwo       ;//  = TimeCordinateTwo;
          double                         Period4Hour_PriceCordinateThree    ;//  = PriceCordinateThree;
          datetime                       Period4Hour_TimeCordinateThree     ;//  = TimeCordinateThree;
          //=================================================================

          //case  PERIOD_M30:
          //================================================================= 
          double                         Period30Min_PriceCordinateOne      ;//  = PriceCordinateOne;
          datetime                       Period30Min_TimeCordinateOne       ;//  = TimeCordinateOne;
          double                         Period30Min_PriceCordinateTwo      ;//  = PriceCordinateTwo;
          datetime                       Period30Min_TimeCordinateTwo       ;//  = TimeCordinateTwo;
          double                         Period30Min_PriceCordinateThree    ;//  = PriceCordinateThree;
          datetime                       Period30Min_TimeCordinateThree     ;//  = TimeCordinateThree;
          //=================================================================
          //case  PERIOD_M5:
          //================================================================= 
          double                         Period5Min_PriceCordinateOne       ;// = PriceCordinateOne;
          datetime                       Period5Min_TimeCordinateOne        ;// = TimeCordinateOne;
          double                         Period5Min_PriceCordinateTwo       ;// = PriceCordinateTwo;
          datetime                       Period5Min_TimeCordinateTwo        ;// = TimeCordinateTwo;
          double                         Period5Min_PriceCordinateThree     ;// = PriceCordinateThree;
          datetime                       Period5Min_TimeCordinateThree      ;// = TimeCordinateThree;
          //=================================================================
          ...
          {         GDS.Set_Action_2(WhichMode, IsKey);
                    ...
                    //---
                    GDS.Set_Common_6(false, 100, true, false, true, Arc_DEF_tooltip + "Fibos.Arc" + n);
                    GDS.Set_Chart_6();
...
//===================================================================
          bool Create(bool Is_Create, bool Is_Move, const string Arc_Name = "GDS", const string Description = "oArcDescription",
...
//|                                                                  |
//+------------------------------------------------------------------+
bool C_FibosArc::Create(bool Is_Create, bool Is_Move, const string Arc_Name = "GDS", const string Description = "oArcDescription",
                        const bool Background = false, const bool Fill = false, const ENUM_LINE_STYLE style = STYLE_DASH, const int Width = 1,
                        color DescColorIN =  C'36, 52, 69', color DescColorNeg = clrRed, const double Angle = 0,
                        const int FontSize = 7, const string Font = "Arial")
{         ________________________________________________________Xerorr.SuperviserX(_LastError, "-C_Fibo Error",  __LINE__, __FUNCTION__); //|
          ...
          //===========================
          if(ObjectFind(ChartData_ChartInfo.ID, Arc_Name) >= 0 && Is_Move )
          {         int CordinateXone = 0; int  CordinateYone = 0;
                    ...
                    ObjectSetInteger(0, Arc_Name, OBJPROP_XDISTANCE, CordinateXone);//Label_.X_Distance(XCordinate);
                    ObjectSetInteger(0, Arc_Name, OBJPROP_YDISTANCE, CordinateYone);////Label_.Y_Distance(YCordinate); //
                    return true;//
          }
          if(ObjectFind(ChartData_ChartInfo.ID, Arc_Name) >= 0 && !Is_Create) {return ObjectDelete(ChartData_ChartInfo.ID, Arc_Name);}
          if(ObjectFind(ChartData_ChartInfo.ID, Arc_Name) < 0)
                    if(! GAC.Create(ChartData_ChartInfo.ID, Arc_Name, ChartData_ChartInfo.SubWindow, TimeCordinateOne, PriceCordinateOne, TimeCordinateTwo, PriceCordinateTwo, scale))Alert("-Line:", __LINE__);;
          if(ObjectFind(ChartData_ChartInfo.ID, Arc_Name) >= 0)
          {         //
                    GAC.Fill(false);
                    GAC.Scale(0.61);
                    ...
                    GAC.Style(1); //GAC.SetInteger(OBJPROP_STYLE, 1);
                    GAC.Width(1);
                    //
                    ...
                    GAC.Z_Order(3);
                    //
                    Dev_Object.FiboService.FiboLeveler(GAC, Arc_Name, Width, style, DescColorIN, DescColorNeg, Gradient) ; //
                    return true;//
          } /////////////////////////////////////============================//============================
          ________________________________________________________Xerorr.SuperviserX(_LastError, "-C_Fibo Error",  __LINE__, __FUNCTION__); //|
          return false;//
