...
//+------------------------------------------------------------------+
#include "../LangX/HashX.mqh"
#property strict
//+------------------------------------------------------------------+
//|                                                                  |
//+------------------------------------------------------------------+
template<typename T>
interface EqualityComparerX
  {
...
//+------------------------------------------------------------------+
template<typename T>
class GenericEqualityComparerX: public EqualityComparerX<T>
  {
public:
   virtual bool       equals(const T left,const T right) const override {return left==right;}
   virtual int        hash(const T value) const override {return HashX(value);}
  };
//+------------------------------------------------------------------+
