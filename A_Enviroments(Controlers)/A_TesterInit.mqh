...
public:
          void C_TesterInit::C_TesterInit() {};
          void C_TesterInit::~C_TesterInit() {};
          void C_TesterInit::Run();
...
{         //double xf = TesterStatistics(STAT_PROFIT), xc = TesterStatistics(STAT_INITIAL_DEPOSIT);
          ...
          // Alert(_LastError);
          ________________________________________________________Xerorr.SuperviserX(_LastError, "-OnTesterInit Error",  __LINE__, __FUNCTION__);
//
}
//====================================================================
//+------------------------------------------------------------------+
