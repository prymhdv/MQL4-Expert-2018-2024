...
public:
          void C_TesterPass::C_TesterPass() {};
          void C_TesterPass::~C_TesterPass() {};
          void C_TesterPass::Run();
...
{         //
          ...
          // Alert(_LastError);
          //
          ________________________________________________________Xerorr.SuperviserX(_LastError, "-OnTesterPass Error",  __LINE__, __FUNCTION__);
//
}
//====================================================================
//+------------------------------------------------------------------+
