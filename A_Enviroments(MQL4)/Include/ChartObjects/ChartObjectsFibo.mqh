...
//+------------------------------------------------------------------+
class CChartObjectFibo : public CChartObjectTrend_MQL4
{
public:
...
//+------------------------------------------------------------------+
class CChartObjectFiboTimes : public CChartObject_MQL4
{
public:
...
//|          Derives from class CChartObject_MQL4.                        |
//+------------------------------------------------------------------+
class CChartObjectFiboFan : public CChartObject_MQL4
{
public:
...
//|          Derives from class CChartObject_MQL4.                        |
//+------------------------------------------------------------------+
class CChartObjectFiboArc : public CChartObject_MQL4
{
public:
          ...
          //---Extr DEV
          bool              CreateCall(long ChartID_, string Name_, int SubWindow_) { return Create(  ChartID_, Name_, SubWindow_, 0, 0, 0, 0, 0);}
          //------------------------------------------------
};
//+------------------------------------------------------------------+
//| Constructor                                                      |
...
//|          Derives from class CChartObjectTrend_MQL4.                   |
//+------------------------------------------------------------------+
class CChartObjectFiboChannel : public CChartObjectTrend_MQL4
{
public:
...
//|          Derives from class CChartObjectTrend_MQL4.                   |
//+------------------------------------------------------------------+
class CChartObjectFiboExpansion : public CChartObjectTrend_MQL4
{
public:
