...
//|          Derives from class CChartObjectTrendByAngle_MQL4.            |
//+------------------------------------------------------------------+
class CChartObjectGannLine : public CChartObjectTrendByAngle_MQL4
  {
public:
...
//+------------------------------------------------------------------+
class CChartObjectGannFan : public CChartObjectTrend_MQL4
  {
public:
...
//|          Derives from class CChartObjectTrend_MQL4.                   |
//+------------------------------------------------------------------+
class CChartObjectGannGrid : public CChartObjectTrend_MQL4
  {
public:
