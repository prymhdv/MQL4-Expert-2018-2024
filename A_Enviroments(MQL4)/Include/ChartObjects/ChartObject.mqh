...
//+------------------------------------------------------------------+
//| Class CChartObject_MQL4.                                              |
//| Pupose: Base class of chart objects.                             |
//|              Derives from class CObject_MQL4.                         |
//+------------------------------------------------------------------+
class CChartObject_MQL4 : public CObject_MQL4
{
protected:
...
//| Constructor                                                      |
//+------------------------------------------------------------------+
CChartObject_MQL4::CChartObject_MQL4(void)
{
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Name(const string name)
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//| Attach object                                                    |
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Attach(long chart_id, const string name, const int window, const int points)
{
//--- check
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::SetPoint(const int point, const datetime time, const double price) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//| Delete an object                                                 |
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Delete(void)
{
//--- checki
          if(m_chart_id == -1)
                    return(false);
...
//| Detach object                                                    |
//+------------------------------------------------------------------+
void CChartObject_MQL4::Detach(void)
{         m_chart_id  = -1;
          m_window    = -1;
          m_name      = NULL;
          m_num_points = 0; }
...
//+------------------------------------------------------------------+
datetime CChartObject_MQL4::Time(const int point) const
{
//--- check
          if(m_chart_id == -1)
                    return(0);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Time(const int point, const datetime time) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
double CChartObject_MQL4::Price(const int point) const
{
//--- check
          if(m_chart_id == -1)
                    return(EMPTY_VALUE);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Price(const int point, const double price) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//| Get object color                                                 |
//+------------------------------------------------------------------+
color CChartObject_MQL4::Color(void) const
{
//--- check
          if(m_chart_id == -1)
                    return(CLR_NONE);
...
//| Set object color                                                 |
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Color(const color new_color) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
ENUM_LINE_STYLE CChartObject_MQL4::Style(void) const
{
//--- check
          if(m_chart_id == -1)
                    return(WRONG_VALUE);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Style(const ENUM_LINE_STYLE new_style) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
int CChartObject_MQL4::Width(void) const
{
//--- check
          if(m_chart_id == -1)
                    return(-1);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Width(const int new_width) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Background(void) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Background(const bool new_back) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Fill(void) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Fill(const bool new_fill) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
long CChartObject_MQL4::Z_Order(void) const
{
//--- check
          if(m_chart_id == -1)
                    return(0);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Z_Order(const long value) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Selected(void) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Selected(const bool new_sel) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Selectable(void) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Selectable(const bool new_sel) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//| Get the "hidden" flag                                            |
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Hidden(void) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Hidden(const bool new_hidden) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
string CChartObject_MQL4::Description(void) const
{
//--- check
          if(m_chart_id == -1)
                    return("");
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Description(const string new_text) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
string CChartObject_MQL4::Tooltip(void) const
{
//--- check
          if(m_chart_id == -1)
                    return("");
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Tooltip(const string new_text) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
int CChartObject_MQL4::Timeframes(void) const
{
//--- check
          if(m_chart_id == -1)
                    return(0);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Timeframes(const int timeframes) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
datetime CChartObject_MQL4::CreateTime(void) const
{
//--- check
          if(m_chart_id == -1)
                    return(0);
...
//+------------------------------------------------------------------+
int CChartObject_MQL4::LevelsCount(void) const
{
//--- check
          if(m_chart_id == -1)
                    return(0);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::LevelsCount(const int new_count) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
color CChartObject_MQL4::LevelColor(const int level) const
{
//--- check
          if(m_chart_id == -1)
                    return(CLR_NONE);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::LevelColor(const int level, const color new_color) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
ENUM_LINE_STYLE CChartObject_MQL4::LevelStyle(const int level) const
{
//--- check
          if(m_chart_id == -1)
                    return(WRONG_VALUE);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::LevelStyle(const int level, const ENUM_LINE_STYLE new_style) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
int CChartObject_MQL4::LevelWidth(const int level) const
{
//--- check
          if(m_chart_id == -1)
                    return(-1);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::LevelWidth(const int level, const int new_width) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
double CChartObject_MQL4::LevelValue(const int level) const
{
//--- check
          if(m_chart_id == -1)
                    return(EMPTY_VALUE);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::LevelValue(const int level, const double new_value) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
string CChartObject_MQL4::LevelDescription(const int level) const
{
//--- check
          if(m_chart_id == -1)
                    return("");
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::LevelDescription(const int level, const string new_text) const
{
//--- checking
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
long CChartObject_MQL4::GetInteger(const ENUM_OBJECT_PROPERTY_INTEGER prop_id, const int modifier) const
{
//--- check
          if(m_chart_id == -1)
                    return(0);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::GetInteger(const ENUM_OBJECT_PROPERTY_INTEGER prop_id, const int modifier, long &value) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::SetInteger(const ENUM_OBJECT_PROPERTY_INTEGER prop_id, const int modifier, const long value) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::SetInteger(const ENUM_OBJECT_PROPERTY_INTEGER prop_id, const long value) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
double CChartObject_MQL4::GetDouble(const ENUM_OBJECT_PROPERTY_DOUBLE prop_id, const int modifier) const
{
//--- check
          if(m_chart_id == -1)
                    return(EMPTY_VALUE);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::GetDouble(const ENUM_OBJECT_PROPERTY_DOUBLE prop_id, const int modifier, double &value) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::SetDouble(const ENUM_OBJECT_PROPERTY_DOUBLE prop_id, const int modifier, const double value) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::SetDouble(const ENUM_OBJECT_PROPERTY_DOUBLE prop_id, const double value) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
string CChartObject_MQL4::GetString(const ENUM_OBJECT_PROPERTY_STRING prop_id, const int modifier) const
{
//--- check
          if(m_chart_id == -1)
                    return("");
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::GetString(const ENUM_OBJECT_PROPERTY_STRING prop_id, const int modifier, string &value) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::SetString(const ENUM_OBJECT_PROPERTY_STRING prop_id, const int modifier, const string value) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::SetString(const ENUM_OBJECT_PROPERTY_STRING prop_id, const string value) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::ShiftObject(const datetime d_time, const double d_price) const
{         bool result = true;
          int  i;
//--- check
          if(m_chart_id == -1)
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::ShiftPoint(const int point, const datetime d_time, const double d_price) const
{
//--- check
          if(m_chart_id == -1)
                    return(false);
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Save(const int file_handle)
{         int    i, len;
          int    levels;
          string str;
//--- check
...
//+------------------------------------------------------------------+
bool CChartObject_MQL4::Load(const int file_handle)
{         int    i, len, num;
          string str;
//--- check
          if(file_handle == INVALID_HANDLE || m_chart_id == -1)
