...
class CChartObjectPanel : public CChartObjectButton
  {
protected:
   CArrayObj_MQL4         m_attachment;       // array of attached objects
   CArrayInt_MQL4         m_dX;               // array of dX attached objects
   CArrayInt_MQL4         m_dY;               // array of dY attached objects
...
bool CChartObjectPanel::Timeframes(const int timeframes)
  {
   int                i;
   bool               res=CChartObject_MQL4::Timeframes(timeframes);
   CChartObjectLabel *chart_object;
//---
   if(m_expanded)
