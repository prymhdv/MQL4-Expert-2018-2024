...
//+------------------------------------------------------------------+
class CString : public CObject_MQL4
{
protected:
          string            m_string;
...
protected:
          virtual int       Compare(const CObject_MQL4 *node, const int mode = 0) const; };
//+------------------------------------------------------------------+
//| Constructor                                                      |
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
int CString::Compare(const CObject_MQL4 *node, const int mode = 0) const
