...
public:
   ...
   bool              AddArray(const CArrayShort_MQL4 *src);
   bool              Insert(const short element,const int pos);
   bool              InsertArray(const short &src[],const int pos);
   bool              InsertArray(const CArrayShort_MQL4 *src,const int pos);
   bool              AssignArray(const short &src[]);
   bool              AssignArray(const CArrayShort_MQL4 *src);
   ...
   bool              CompareArray(const CArrayShort_MQL4 *array) const;
...
//| Constructor                                                      |
//+------------------------------------------------------------------+
CArrayShort_MQL4::CArrayShort_MQL4(void)
  {
...
//+------------------------------------------------------------------+
int CArrayShort_MQL4::MemMove(const int dest,const int src,const int count)
  {
   int i;
//--- check
...
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::Reserve(const int size)
  {
   int new_size;
//--- check
   if(size<=0)
...
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::Resize(const int size)
  {
   int new_size;
//--- check
   if(size<0)
...
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::Shutdown(void)
  {
//--- check
   if(m_data_max==0)
      return(true);
...
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::Add(const short element)
  {
...
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::AddArray(const short &src[])
  {
...
//| Adding an element to the end of the array from another array     |
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::AddArray(const CArrayShort_MQL4 *src)
  {
   int num;
//--- check
   if(!CheckPointer(src))
...
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::Insert(const short element,const int pos)
  {
//--- check/reserve elements of array
   if(pos<0 || !Reserve(1))
      return(false);
...
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::InsertArray(const short &src[],const int pos)
  {
   int num=ArraySize(src);
//--- check/reserve elements of array
   if(!Reserve(num))
...
//| Inserting elements in the specified position                     |
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::InsertArray(const CArrayShort_MQL4 *src,const int pos)
  {
   int num;
//--- check
   if(!CheckPointer(src))
...
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::AssignArray(const short &src[])
  {
   int num=ArraySize(src);
//--- check/reserve elements of array
   Clear();
...
//| Assignment (copying) of another array                            |
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::AssignArray(const CArrayShort_MQL4 *src)
  {
   int num;
//--- check
   if(!CheckPointer(src))
...
//+------------------------------------------------------------------+
short CArrayShort_MQL4::At(const int index) const
  {
//--- check
...
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::Update(const int index,const short element)
  {
//--- check
   if(index<0 || index>=m_data_total)
      return(false);
...
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::Shift(const int index,const int shift)
  {
   short tmp_short;
//--- check
...
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::Delete(const int index)
  {
//--- check
   if(index<0 || index>=m_data_total)
      return(false);
...
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::DeleteRange(int from,int to)
  {
//--- check
   if(from<0 || to<0)
      return(false);
...
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::CompareArray(const short &array[]) const
  {
//--- compare
...
//| Equality comparison of two arrays                                |
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::CompareArray(const CArrayShort_MQL4 *array) const
  {
//--- check
...
//| Method QuickSort                                                 |
//+------------------------------------------------------------------+
void CArrayShort_MQL4::QuickSort(int beg,int end,const int mode)
  {
   int   i,j;
...
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::InsertSort(const short element)
  {
   int pos;
//--- check
   if(!IsSorted())
...
//+------------------------------------------------------------------+
int CArrayShort_MQL4::SearchLinear(const short element) const
  {
//--- check
   if(m_data_total==0)
      return(-1);
...
//+------------------------------------------------------------------+
int CArrayShort_MQL4::QuickSearch(const short element) const
  {
   int   i,j,m=-1;
   short t_short;
//--- search
...
//+------------------------------------------------------------------+
int CArrayShort_MQL4::Search(const short element) const
  {
   int pos;
//--- check
...
//+------------------------------------------------------------------+
int CArrayShort_MQL4::SearchGreat(const short element) const
  {
   int pos;
//--- check
   if(m_data_total==0 || !IsSorted())
...
//+------------------------------------------------------------------+
int CArrayShort_MQL4::SearchLess(const short element) const
  {
   int pos;
//--- check
   if(m_data_total==0 || !IsSorted())
...
//+------------------------------------------------------------------+
int CArrayShort_MQL4::SearchGreatOrEqual(const short element) const
  {
//--- check
   if(m_data_total==0 || !IsSorted())
      return(-1);
...
//+------------------------------------------------------------------+
int CArrayShort_MQL4::SearchLessOrEqual(const short element) const
  {
//--- check
   if(m_data_total==0 || !IsSorted())
      return(-1);
...
//+------------------------------------------------------------------+
int CArrayShort_MQL4::SearchFirst(const short element) const
  {
   int pos;
//--- check
   if(m_data_total==0 || !IsSorted())
...
//+------------------------------------------------------------------+
int CArrayShort_MQL4::SearchLast(const short element) const
  {
   int pos;
//--- check
   if(m_data_total==0 || !IsSorted())
...
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::Save(const int file_handle)
  {
   int i=0;
//--- check
...
//+------------------------------------------------------------------+
bool CArrayShort_MQL4::Load(const int file_handle)
  {
   int i=0,num;
//--- check
