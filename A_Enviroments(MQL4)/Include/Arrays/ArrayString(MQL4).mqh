...
public:
   ...
   bool              AddArray(const CArrayString_MQL4 *src);
   bool              Insert(const string element,const int pos);
   bool              InsertArray(const string &src[],const int pos);
   bool              InsertArray(const CArrayString_MQL4 *src,const int pos);
   bool              AssignArray(const string &src[]);
   bool              AssignArray(const CArrayString_MQL4 *src);
   ...
   bool              CompareArray(const CArrayString_MQL4 *array) const;
...
//| Constructor                                                      |
//+------------------------------------------------------------------+
CArrayString_MQL4::CArrayString_MQL4(void)
  {
...
//+------------------------------------------------------------------+
int CArrayString_MQL4::MemMove(const int dest,const int src,const int count)
  {
   int i;
//--- check
...
//+------------------------------------------------------------------+
bool CArrayString_MQL4::Reserve(const int size)
  {
   int new_size;
//--- check
   if(size<=0)
...
//+------------------------------------------------------------------+
bool CArrayString_MQL4::Resize(const int size)
  {
   int new_size;
//--- check
   if(size<0)
...
//+------------------------------------------------------------------+
bool CArrayString_MQL4::Shutdown(void)
  {
//--- check
   if(m_data_max==0)
      return(true);
...
//+------------------------------------------------------------------+
bool CArrayString_MQL4::Add(const string element)
  {
...
//+------------------------------------------------------------------+
bool CArrayString_MQL4::AddArray(const string &src[])
  {
...
//| Adding an element to the end of the array from another array     |
//+------------------------------------------------------------------+
bool CArrayString_MQL4::AddArray(const CArrayString_MQL4 *src)
  {
   int num;
//--- check
   if(!CheckPointer(src))
...
//+------------------------------------------------------------------+
bool CArrayString_MQL4::Insert(const string element,const int pos)
  {
//--- check/reserve elements of array
   if(pos<0 || !Reserve(1))
      return(false);
...
//+------------------------------------------------------------------+
bool CArrayString_MQL4::InsertArray(const string &src[],const int pos)
  {
   int num=ArraySize(src);
//--- check/reserve elements of array
   if(!Reserve(num))
...
//| Inserting elements in the specified position                     |
//+------------------------------------------------------------------+
bool CArrayString_MQL4::InsertArray(const CArrayString_MQL4 *src,const int pos)
  {
   int num;
//--- check
   if(!CheckPointer(src))
...
//+------------------------------------------------------------------+
bool CArrayString_MQL4::AssignArray(const string &src[])
  {
   int num=ArraySize(src);
//--- check/reserve elements of array
   Clear();
...
//| Assignment (copying) of another array                            |
//+------------------------------------------------------------------+
bool CArrayString_MQL4::AssignArray(const CArrayString_MQL4 *src)
  {
   int num;
//--- check
   if(!CheckPointer(src))
...
//+------------------------------------------------------------------+
string CArrayString_MQL4::At(const int index) const
  {
//--- check
...
//+------------------------------------------------------------------+
bool CArrayString_MQL4::Update(const int index,const string element)
  {
//--- check
   if(index<0 || index>=m_data_total)
      return(false);
...
//+------------------------------------------------------------------+
bool CArrayString_MQL4::Shift(const int index,const int shift)
  {
   string tmp_string;
//--- check
...
//+------------------------------------------------------------------+
bool CArrayString_MQL4::Delete(const int index)
  {
//--- check
   if(index<0 || index>=m_data_total)
      return(false);
...
//+------------------------------------------------------------------+
bool CArrayString_MQL4::DeleteRange(int from,int to)
  {
//--- check
   if(from<0 || to<0)
      return(false);
...
//+------------------------------------------------------------------+
bool CArrayString_MQL4::CompareArray(const string &array[]) const
  {
//--- compare
...
//| Equality comparison of two arrays                                |
//+------------------------------------------------------------------+
bool CArrayString_MQL4::CompareArray(const CArrayString_MQL4 *array) const
  {
//--- check
...
//| Method QuickSort                                                 |
//+------------------------------------------------------------------+
void CArrayString_MQL4::QuickSort(int beg,int end,const int mode)
  {
   int    i,j;
   string p_string;
   string t_string;
...
//+------------------------------------------------------------------+
bool CArrayString_MQL4::InsertSort(const string element)
  {
   int pos;
//--- check
   if(!IsSorted())
...
//+------------------------------------------------------------------+
int CArrayString_MQL4::SearchLinear(const string element) const
  {
//--- check
   if(m_data_total==0)
      return(-1);
...
//+------------------------------------------------------------------+
int CArrayString_MQL4::QuickSearch(const string element) const
  {
   int    i,j,m=-1;
   string t_string;
//--- search
...
//+------------------------------------------------------------------+
int CArrayString_MQL4::Search(const string element) const
  {
   int pos;
//--- check
...
//+------------------------------------------------------------------+
int CArrayString_MQL4::SearchGreat(const string element) const
  {
   int pos;
//--- check
   if(m_data_total==0 || !IsSorted())
...
//+------------------------------------------------------------------+
int CArrayString_MQL4::SearchLess(const string element) const
  {
   int pos;
//--- check
   if(m_data_total==0 || !IsSorted())
...
//+------------------------------------------------------------------+
int CArrayString_MQL4::SearchGreatOrEqual(const string element) const
  {
//--- check
   if(m_data_total==0 || !IsSorted())
      return(-1);
...
//+------------------------------------------------------------------+
int CArrayString_MQL4::SearchLessOrEqual(const string element) const
  {
//--- check
   if(m_data_total==0 || !IsSorted())
      return(-1);
...
//+------------------------------------------------------------------+
int CArrayString_MQL4::SearchFirst(const string element) const
  {
   int pos;
//--- check
   if(m_data_total==0 || !IsSorted())
...
//+------------------------------------------------------------------+
int CArrayString_MQL4::SearchLast(const string element) const
  {
   int pos;
//--- check
   if(m_data_total==0 || !IsSorted())
...
//+------------------------------------------------------------------+
bool CArrayString_MQL4::Save(const int file_handle)
  {
   int i=0,len;
//--- check
...
//+------------------------------------------------------------------+
bool CArrayString_MQL4::Load(const int file_handle)
  {
   int i=0,num,len;
//--- check
