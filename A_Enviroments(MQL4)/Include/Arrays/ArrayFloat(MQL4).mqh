...
public:
   ...
   bool              AddArray(const CArrayFloat_MQL4 *src);
   bool              Insert(const float element,const int pos);
   bool              InsertArray(const float &src[],const int pos);
   bool              InsertArray(const CArrayFloat_MQL4 *src,const int pos);
   bool              AssignArray(const float &src[]);
   bool              AssignArray(const CArrayFloat_MQL4 *src);
   ...
   bool              CompareArray(const CArrayFloat_MQL4 *array) const;
...
//| Constructor                                                      |
//+------------------------------------------------------------------+
CArrayFloat_MQL4::CArrayFloat_MQL4(void) : m_delta(0.0)
  {
...
//| Destructor                                                       |
//+------------------------------------------------------------------+
CArrayFloat_MQL4::~CArrayFloat_MQL4(void)
  {
   if(m_data_max!=0)
      Shutdown();
  }
...
//+------------------------------------------------------------------+
int CArrayFloat_MQL4::MemMove(const int dest,const int src,const int count)
  {
   int i;
//--- check
...
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::Reserve(const int size)
  {
   int new_size;
//--- check
   if(size<=0)
...
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::Resize(const int size)
  {
   int new_size;
//--- check
   if(size<0)
...
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::Shutdown(void)
  {
//--- check
   if(m_data_max==0)
      return(true);
...
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::Add(const float element)
  {
...
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::AddArray(const float &src[])
  {
...
//| Adding an element to the end of the array from another array     |
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::AddArray(const CArrayFloat_MQL4 *src)
  {
   int num;
//--- check
   if(!CheckPointer(src))
...
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::Insert(const float element,const int pos)
  {
//--- check/reserve elements of array
   if(pos<0 || !Reserve(1))
      return(false);
...
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::InsertArray(const float &src[],const int pos)
  {
   int num=ArraySize(src);
//--- check/reserve elements of array
   if(!Reserve(num))
...
//| Inserting elements in the specified position                     |
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::InsertArray(const CArrayFloat_MQL4 *src,const int pos)
  {
   int num;
//--- check
   if(!CheckPointer(src))
...
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::AssignArray(const float &src[])
  {
   int num=ArraySize(src);
//--- check/reserve elements of array
   Clear();
...
//| Assignment (copying) of another array                            |
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::AssignArray(const CArrayFloat_MQL4 *src)
  {
   int num;
//--- check
   if(!CheckPointer(src))
...
//+------------------------------------------------------------------+
float CArrayFloat_MQL4::At(const int index) const
  {
//--- check
...
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::Update(const int index,const float element)
  {
//--- check
   if(index<0 || index>=m_data_total)
      return(false);
...
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::Shift(const int index,const int shift)
  {
   float tmp_float;
//--- check
...
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::Delete(const int index)
  {
//--- check
   if(index<0 || index>=m_data_total)
      return(false);
...
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::DeleteRange(int from,int to)
  {
//--- check
   if(from<0 || to<0)
      return(false);
...
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::CompareArray(const float &array[]) const
  {
//--- compare
...
//| Equality comparison of two arrays                                |
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::CompareArray(const CArrayFloat_MQL4 *array) const
  {
//--- check
...
//| Method QuickSort                                                 |
//+------------------------------------------------------------------+
void CArrayFloat_MQL4::QuickSort(int beg,int end,const int mode)
  {
   int   i,j;
...
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::InsertSort(const float element)
  {
   int pos;
//--- check
   if(!IsSorted())
...
//+------------------------------------------------------------------+
int CArrayFloat_MQL4::SearchLinear(const float element) const
  {
//--- check
   if(m_data_total==0)
      return(-1);
...
//+------------------------------------------------------------------+
int CArrayFloat_MQL4::QuickSearch(const float element) const
  {
   int   i,j,m=-1;
   float t_float;
//--- search
...
//+------------------------------------------------------------------+
int CArrayFloat_MQL4::Search(const float element) const
  {
   int pos;
//--- check
...
//+------------------------------------------------------------------+
int CArrayFloat_MQL4::SearchGreat(const float element) const
  {
   int pos;
//--- check
   if(m_data_total==0 || !IsSorted())
...
//+------------------------------------------------------------------+
int CArrayFloat_MQL4::SearchLess(const float element) const
  {
   int pos;
//--- check
   if(m_data_total==0 || !IsSorted())
...
//+------------------------------------------------------------------+
int CArrayFloat_MQL4::SearchGreatOrEqual(const float element) const
  {
//--- check
   if(m_data_total==0 || !IsSorted())
      return(-1);
...
//+------------------------------------------------------------------+
int CArrayFloat_MQL4::SearchLessOrEqual(const float element) const
  {
//--- check
   if(m_data_total==0 || !IsSorted())
      return(-1);
...
//+------------------------------------------------------------------+
int CArrayFloat_MQL4::SearchFirst(const float element) const
  {
   int pos;
//--- check
   if(m_data_total==0 || !IsSorted())
...
//+------------------------------------------------------------------+
int CArrayFloat_MQL4::SearchLast(const float element) const
  {
   int pos;
//--- check
   if(m_data_total==0 || !IsSorted())
...
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::Save(const int file_handle)
  {
   int i=0;
//--- check
...
//+------------------------------------------------------------------+
bool CArrayFloat_MQL4::Load(const int file_handle)
  {
   int i=0,num;
//--- check
