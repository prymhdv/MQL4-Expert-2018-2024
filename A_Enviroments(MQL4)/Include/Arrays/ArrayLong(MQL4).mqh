...
public:
   ...
   bool              AddArray(const CArrayLong_MQL4 *src);
   bool              Insert(const long element,const int pos);
   bool              InsertArray(const long &src[],const int pos);
   bool              InsertArray(const CArrayLong_MQL4 *src,const int pos);
   bool              AssignArray(const long &src[]);
   bool              AssignArray(const CArrayLong_MQL4 *src);
   ...
   bool              CompareArray(const CArrayLong_MQL4 *array) const;
...
//| Constructor                                                      |
//+------------------------------------------------------------------+
CArrayLong_MQL4::CArrayLong_MQL4(void)
  {
...
//+------------------------------------------------------------------+
int CArrayLong_MQL4::MemMove(const int dest,const int src,const int count)
  {
   int i;
//--- check
...
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::Reserve(const int size)
  {
   int new_size;
//--- check
   if(size<=0)
...
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::Resize(const int size)
  {
   int new_size;
//--- check
   if(size<0)
...
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::Shutdown(void)
  {
//--- check
   if(m_data_max==0)
      return(true);
...
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::Add(const long element)
  {
...
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::AddArray(const long &src[])
  {
...
//| Adding an element to the end of the array from another array     |
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::AddArray(const CArrayLong_MQL4 *src)
  {
   int num;
//--- check
   if(!CheckPointer(src))
...
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::Insert(const long element,const int pos)
  {
//--- check/reserve elements of array
   if(pos<0 || !Reserve(1))
      return(false);
...
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::InsertArray(const long &src[],const int pos)
  {
   int num=ArraySize(src);
//--- check/reserve elements of array
   if(!Reserve(num))
...
//| Inserting elements in the specified position                     |
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::InsertArray(const CArrayLong_MQL4 *src,const int pos)
  {
   int num;
//--- check
   if(!CheckPointer(src))
...
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::AssignArray(const long &src[])
  {
   int num=ArraySize(src);
//--- check/reserve elements of array
   Clear();
...
//| Assignment (copying) of another array                            |
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::AssignArray(const CArrayLong_MQL4 *src)
  {
   int num;
//--- check
   if(!CheckPointer(src))
...
//+------------------------------------------------------------------+
long CArrayLong_MQL4::At(const int index) const
  {
//--- check
...
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::Update(const int index,const long element)
  {
//--- check
   if(index<0 || index>=m_data_total)
      return(false);
...
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::Shift(const int index,const int shift)
  {
   long tmp_long;
//--- check
...
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::Delete(const int index)
  {
//--- check
   if(index<0 || index>=m_data_total)
      return(false);
...
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::DeleteRange(int from,int to)
  {
//--- check
   if(from<0 || to<0)
      return(false);
...
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::CompareArray(const long &array[]) const
  {
//--- compare
...
//| Equality comparison of two arrays                                |
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::CompareArray(const CArrayLong_MQL4 *array) const
  {
//--- check
...
//| Method QuickSort                                                 |
//+------------------------------------------------------------------+
void CArrayLong_MQL4::QuickSort(int beg,int end,const int mode)
  {
   int i,j;
   long p_long,t_long;
//--- check
...
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::InsertSort(const long element)
  {
   int pos;
//--- check
   if(!IsSorted())
...
//+------------------------------------------------------------------+
int CArrayLong_MQL4::SearchLinear(const long element) const
  {
//--- check
   if(m_data_total==0)
      return(-1);
...
//+------------------------------------------------------------------+
int CArrayLong_MQL4::QuickSearch(const long element) const
  {
   int  i,j,m=-1;
   long t_long;
//--- search
...
//+------------------------------------------------------------------+
int CArrayLong_MQL4::Search(const long element) const
  {
   int pos;
//--- check
...
//+------------------------------------------------------------------+
int CArrayLong_MQL4::SearchGreat(const long element) const
  {
   int pos;
//--- check
   if(m_data_total==0 || !IsSorted())
...
//+------------------------------------------------------------------+
int CArrayLong_MQL4::SearchLess(const long element) const
  {
   int pos;
//--- check
   if(m_data_total==0 || !IsSorted())
...
//+------------------------------------------------------------------+
int CArrayLong_MQL4::SearchGreatOrEqual(const long element) const
  {
//--- check
   if(m_data_total==0 || !IsSorted())
      return(-1);
...
//+------------------------------------------------------------------+
int CArrayLong_MQL4::SearchLessOrEqual(const long element) const
  {
//--- check
   if(m_data_total==0 || !IsSorted())
      return(-1);
...
//+------------------------------------------------------------------+
int CArrayLong_MQL4::SearchFirst(const long element) const
  {
   int pos;
//--- check
   if(m_data_total==0 || !IsSorted())
...
//+------------------------------------------------------------------+
int CArrayLong_MQL4::SearchLast(const long element) const
  {
   int pos;
//--- check
   if(m_data_total==0 || !IsSorted())
...
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::Save(const int file_handle)
  {
   int i=0;
//--- check
...
//+------------------------------------------------------------------+
bool CArrayLong_MQL4::Load(const int file_handle)
  {
   int i=0,num;
//--- check
