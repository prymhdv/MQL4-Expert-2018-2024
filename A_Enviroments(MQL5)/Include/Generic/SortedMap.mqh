...
//|                                             https://www.mql5.com |
//+------------------------------------------------------------------+
#include <.RTL_Prymhdv\QuartsExperts\A_Enviroments(MQL5)\Include\Generic\Interfaces\IMap.mqh>
#include <.RTL_Prymhdv\QuartsExperts\A_Enviroments(MQL5)\Include\Generic\Interfaces\IComparer.mqh>
#include <.RTL_Prymhdv\QuartsExperts\A_Enviroments(MQL5)\Include\Generic\Internal\DefaultComparer.mqh>
#include <.RTL_Prymhdv\QuartsExperts\A_Enviroments(MQL5)\Include\Generic\Internal\CompareFunction.mqh>
#include "HashMap.mqh"
...
public:
          ...
          {         if(!b)   { return; }
                    ...
                    SortedMap_string_int.Add("Jon", 10);
                    SortedMap_string_int.Add("Alex", 20);
                    SortedMap_string_int.Add("Marry", 30);
                    SortedMap_string_int.Add("Pourya", 40);
                    //
                    Alert("frist SortedMap_string_int.Contains: ", SortedMap_string_int.Contains("Alex", 20));
                    SortedMap_string_int.Remove("Alex");
                    Alert("frist SortedMap_string_int.Contains: ", SortedMap_string_int.Contains("Alex", 20));
                    SortedMap_string_int.Remove("Jon");
                    Alert("frist SortedMap_string_int.ContainsKey: ", SortedMap_string_int.ContainsKey("Jon"));
                    SortedMap_string_int.Clear();
                    //
          } //
          void Main2(bool b)
          {         if(!b)   { return; }
                    ...
                    SortedMap_string_int1.Add("Jon", E_Void);
                    SortedMap_string_int1.Add("Alex", E_True);
                    SortedMap_string_int1.Add("Marry", E_False);
                    SortedMap_string_int1.Add("Pourya", E_False);
                    //
                    Print("frist SortedMap_string_int.Contains: ", SortedMap_string_int1.Contains("Alex", E_True));
                    SortedMap_string_int1.Remove("Alex");
                    Print("frist SortedMap_string_int.Contains: ", SortedMap_string_int1.Contains("Alex", E_True));
                    SortedMap_string_int1.Remove("Jon");
                    Print("frist SortedMap_string_int.ContainsKey: ", SortedMap_string_int1.ContainsKey("Jon"));
                    SortedMap_string_int1.Clear(); //
          }
