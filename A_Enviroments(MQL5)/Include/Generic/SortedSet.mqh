...
//|                                             https://www.mql5.com |
//+------------------------------------------------------------------+
#include <.RTL_Prymhdv\QuartsExperts\A_Enviroments(MQL5)\Include\Generic\Interfaces\ISet.mqh>
#include <.RTL_Prymhdv\QuartsExperts\A_Enviroments(MQL5)\Include\Generic\Internal\Introsort.mqh>
...
public:
          ...
          {         if(!b)   { return; }
                    ...
                    SortedSet_int.Add(10);
                    SortedSet_int.Add(20);
                    SortedSet_int.Add(30);
                    SortedSet_int.Add(40);
                    //
                    Alert("frist SortedSet_int.Contains: ", SortedSet_int.Contains(50));
                    SortedSet_int.Remove(30);
                     Alert("frist SortedSet_int.Contains: ", SortedSet_int.Contains(30));
                    SortedSet_int.Clear();
                    //
          } //
};
